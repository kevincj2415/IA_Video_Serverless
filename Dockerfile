...
RUN pip install git+https://github.com/huggingface/diffusers.git transformers accelerate safetensors sentencepiece protobuf peft runpod imageio[ffmpeg] --upgrade --break-system-packages
